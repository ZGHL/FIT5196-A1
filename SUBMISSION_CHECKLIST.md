...
- [ ] Add the five student IDs to the notebook cover before submission.
- [x] Clean-directory run recreated all six CSVs byte-for-byte, all figures and the 10-page PDF.
- [ ] Run `python3 processing/code/build/build_final_submission.py` after the two AI items above are complete; it blocks incomplete archives and keeps `Group030_EDA.pdf` outside the ZIP.
