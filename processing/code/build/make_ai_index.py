...
RECORDS = [
    {"id": "AI-01", "member": "Xinhang Ren (35134410)", "file": "AI-01.pdf",
     ...
     "verification": "Requirements were checked against the official specification and rubric. The final workflow passed 18/18 public text tests, 22/22 student-designed tests and 68/68 validation checks. Both notebooks were rerun in a clean offline marking-style workspace."},
    {"id": "AI-02", "member": "Guohou Zhang (35800275) & King Man Chan (36550779)", "file": "AI-02.pdf",
     ...
     "verification": "Recommendations were checked against the public data dictionary, source reconciliation counts and executable VAL-* register. The final register contains 68/68 PASS results and reports observed values rather than relying only on hard-coded expected counts."},
    ...
    {"id": "AI-04", "member": "Guohou Zhang (35800275)", "file": "AI-04.pdf",
     ...
     "verification": "The implementation was checked against the published text contract, 18/18 public cases and 22/22 student-designed edge cases. Multilingual checks confirm that 303 reviews containing non-Latin script remain identified after cleaning."},
    {"id": "AI-05", "member": "King Man Chan (36550779)", "file": "AI-05.pdf",
     ...
     "verification": "The additional cases were executed through the same expected-versus-actual test harness as the public suite. The final notebook reports 18/18 public cases and 22/22 student-designed cases passing."},
    {"id": "AI-06", "member": "Sizhe Hong (35381949)", "file": "AI-06.html",
     ...
     "verification": "The record separates assignment-stated requirements from assumptions and recommends field-specific checks, expected-versus-actual evidence and row-level relationship diagnostics. Related implementation is covered by the final executable VAL-* register, which reports 68/68 PASS results."},
]
