...
def build_html() -> str:
    ...
    * { box-sizing: border-box; }
    ...
    <main class="report-flow">
      ...
      <tr><td>Apply field-specific text rules</td><td>Lower-case three designated narratives; preserve delivery-note case; remove published wrappers and emoji.</td><td><code>VAL-TEXT-02</code>, <code>09</code>–<code>12</code>: 303 non-Latin reviews retained; case checks pass; wrapper and emoji residue are zero.</td></tr>
      </tbody></table>
